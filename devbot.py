...
choice = input("Do you wish to use the hard-coded Webex token? (y/n) ").lower()

if choice == "n":
    # If the user chooses not to use the hard-coded token, ask for user input
    accessToken = input("Enter your Webex access token: ")
else:
    # Use the hard-coded token
    accessToken = "YmIwZDE2OTEtYTVlMi00YThjLWE4N2EtNTRiMjBlNDMyY2NkZGJkYjA3ZjktM2Yx_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
...
# Loop through rooms and print type and title
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "NFMpskgCuhBoNuztya6qjoQB1HGQFSNv"
                               }
...
# 10. Provide the Sunrise/Sunset key value for day_length.
        dayLengthSeconds = 09.47.44
        sunriseTime = 7:15:09 AM 
        sunsetTime = 5:02:53 PM
...
# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": YmIwZDE2OTEtYTVlMi00YThjLWE4N2EtNTRiMjBlNDMyY2NkZGJkYjA3ZjktM2Yx_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0
